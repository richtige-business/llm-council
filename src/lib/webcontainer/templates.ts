// ============================================
// LLM Council Module Builder - WebContainer Templates
//
...
const BASE_PACKAGE_JSON = {
  name: 'llm-council-module-preview',
  private: true,
  type: 'module',
  scripts: {
    dev: 'vite --host',
...
// --------------------------------------------
// Vite Config
// React Plugin + @/ Alias fuer LLM Council-Imports
// --------------------------------------------
...
// --------------------------------------------
// index.html
// Dunkler Hintergrund passend zum LLM Council-Design
// --------------------------------------------
...
// --------------------------------------------
// Mock: @/lib/theme
// Stellt useThemeStyles() bereit wenn Module den LLM Council-Theme importieren
// --------------------------------------------

const THEME_MOCK = `// Mock fuer @/lib/theme - LLM Council Theme-Styles
