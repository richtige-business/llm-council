...
export const legacyPhrasePairs: LegacyPhrasePair[] = [
  ...
  { de: 'Personalisiere dein LifeOS', en: 'Customize your LifeOS' },
  ...
  { de: 'Designs, Praesentationen, Whiteboards und Social Assets direkt als Web-App in LifeOS nutzen.', en: 'Use designs, presentations, whiteboards, and social assets directly as a web app in LifeOS.' },
  ...
  { de: 'Produktdesign, UI-Files, Komponenten und FigJam-Boards als kreative Web-App in LifeOS verwenden.', en: 'Use product design, UI files, components, and FigJam boards as a creative web app in LifeOS.' },
  ...
  { de: 'Channels, Threads, Nachrichten und Team-Kommunikation als zentrale Web-App in LifeOS zusammenfuehren.', en: 'Bring channels, threads, messages, and team communication together as a central web app in LifeOS.' },
  { de: 'Feeds, DMs, Creator-Posts und Community-Management ueber die Instagram-Web-App in LifeOS oeffnen.', en: 'Open feeds, DMs, creator posts, and community management through the Instagram web app in LifeOS.' },
];
