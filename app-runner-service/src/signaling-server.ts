...
class SignalingRelay {
  ...
  private handleBrowserConnection(browserWs: WebSocket, sessionId: string): void {
  ...
  private connectToHelper(sessionId: string, relay: NonNullable<ReturnType<typeof this.relays.get>>): void {
