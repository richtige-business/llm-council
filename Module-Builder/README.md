...
[bolt.diy: AI-Powered Full-Stack Web Development in the Browser](https://bolt.diy)
...
[Download Latest Release](https://github.com/stackblitz-labs/bolt.diy/releases/latest) ← Click here to go to the latest release version!
...
4. Verify Node.js is properly installed:
  ...
  6. Type this command:
    ```bash
     echo $PATH
    ```
  7. Look for `/usr/local/bin` in the output
